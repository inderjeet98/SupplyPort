...
class ItemListViewBrandCat extends StatefulWidget {
  const ItemListViewBrandCat(
      {Key? key,
      this.imagurl,
      this.itemId,
      this.itemname,
  ...
  @override
  State<ItemListViewBrandCat> createState() => _ItemListViewBrandCatState();
}

class _ItemListViewBrandCatState extends State<ItemListViewBrandCat> {
  @override
  void initState() {
          ...
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Rs. ${(price * itmQty).toDouble().toStringAsFixed(2)}/-',
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                      color: Color.fromRGBO(29, 55, 84, 1),
                      fontFamily: 'Arboria-Medium',
