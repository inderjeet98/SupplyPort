...
List<ServiceData> serviceDataFromJson(String str) => List<ServiceData>.from(
    json.decode(str).map((x) => ServiceData.fromJson(x)));

String serviceDataToJson(List<ServiceData> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ServiceData {
  ServiceData({required this.data});
